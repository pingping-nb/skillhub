      ...
      <div className="flex-1 overflow-auto bg-[#fafafa] p-4 font-mono text-[12px] leading-[1.7] dark:bg-neutral-950">
        ...
        <div className="mb-3">
          <div className="flex items-start gap-2">
            ...
            <div className="flex-1">
              <span className="text-neutral-800 dark:text-neutral-200">npx -y --registry {CLI_NPM_REGISTRY} @neobards/skillhub@0.1.12 --version</span>
              <button
                type="button"
                onClick={() => handleCopy(`npx -y --registry ${CLI_NPM_REGISTRY} @neobards/skillhub@0.1.12 --version`, 0)}
        ...
        <div className="mb-3">
          <div className="flex items-start gap-2">
            <span className="select-none font-bold text-emerald-600 dark:text-emerald-400">$</span>
            <div className="flex-1">
              <span className="text-neutral-800 dark:text-neutral-200">npx -y --registry {CLI_NPM_REGISTRY} @neobards/skillhub@0.1.12 search weather \</span>
              <button
                type="button"
                onClick={() => handleCopy(`npx -y --registry ${CLI_NPM_REGISTRY} @neobards/skillhub@0.1.12 search weather --registry ${registryUrl} --limit 5`, 1)}
                className="ml-2 inline-flex items-center gap-0.5 rounded px-1.5 py-0.5 text-[10px] text-muted-foreground align-middle transition-[color,background-color,transform] hover:bg-neutral-100 hover:text-foreground active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring dark:hover:bg-neutral-800"
              >
        ...
        <div className="mb-3">
          <div className="flex items-start gap-2">
            <span className="select-none font-bold text-emerald-600 dark:text-emerald-400">$</span>
            <div className="flex-1">
              <span className="text-neutral-800 dark:text-neutral-200">npx -y --registry {CLI_NPM_REGISTRY} @neobards/skillhub@0.1.12 install @global/weather \</span>
              <button
                type="button"
                onClick={() => handleCopy(`npx -y --registry ${CLI_NPM_REGISTRY} @neobards/skillhub@0.1.12 install @global/weather --dir ./skills --registry ${registryUrl}`, 2)}
                className="ml-2 inline-flex items-center gap-0.5 rounded px-1.5 py-0.5 text-[10px] text-muted-foreground align-middle transition-[color,background-color,transform] hover:bg-neutral-100 hover:text-foreground active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring dark:hover:bg-neutral-800"
              >
