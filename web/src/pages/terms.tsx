...
const termsDocuments = {
  zh: {
    eyebrow: '法律與政策',
    title: '服務條款',
    summary: '本條款適用於你訪問和使用 SkillHub 提供的技能瀏覽、發布、審核、下載、賬號管理和 API 相關服務。使用本服務即表示你同意受本條款約束。',
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          '你需對透過自己賬號發生的活動負責，包括髮布、審核、下載、生成令牌和管理名稱空間的操作。',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '你承諾對自己提交的技能包、README、描述、截圖、審核意見和其他材料負責，並保證你有權上傳這些內容。',
        ],
        bullets: [
          '不得上傳惡意程式碼、違法內容、侵權內容、欺詐性內容或故意誤導使用者的材料。',
          '不得冒用他人身份、未經授權佔用名稱空間，或規避平臺的審核與訪問控制機制。',
      ...
      },
      {
        title: '4. 審核、治理與執行',
        paragraphs: [
          'SkillHub 可對發布內容執行審核、隱藏、下架、拒絕、撤回版本、限制訪問或暫停賬號等治理動作，以維護平臺安全、合規和服務質量。',
      ...
      },
      {
        title: '7. 服務可用性與免責宣告',
        paragraphs: [
          '我們可以隨時調整、更新、限制或中斷部分功能，包括搜尋、下載、審核、登入方式和 API 能力，且不保證任何功能持續可用。',
