...
const privacyDocuments = {
  zh: {
    eyebrow: '法律與隱私',
    title: '隱私政策',
    summary: '本政策說明 SkillHub 在提供技能註冊、發布、審核、下載、賬號登入和相關 API 服務時，如何收集、使用、共享並保護與你有關的資訊。',
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          '當你瀏覽技能、發布版本、參與審核、生成令牌或下載內容時，本政策描述我們如何處理與你相關的資訊。',
        ],
      },
      {
        title: '2. 我們收集的資訊',
        ...
        bullets: [
          ...
          '你主動提交的內容，例如技能包、README、版本說明、名稱空間資料、評分、星標和審核意見。',
      ...
      },
      {
        title: '5. 資料保留',
        paragraphs: [
          '我們會在實現業務目的所需的期限內保留賬戶資料、技能後設資料、審核記錄和安全日誌，並可能在法律、審計或合規要求下延長保留期限。',
